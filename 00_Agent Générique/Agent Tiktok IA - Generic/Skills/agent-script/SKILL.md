...
4. `Context/style.md`
5. `Examples/meilleurs_scripts.md` — les 4 scripts [TON_COMPTE] avec leurs performances
...
Tous les hooks [TON_COMPTE] utilisent le **système Double Hook** (2 lignes, ironie ou contraste). Choisir les types les plus adaptés au sujet parmi :
...
> Preuve terrain [TON_COMPTE] : ancrage = chute -20% de rétention en 5 secondes (Napoléon, Henri IV).
