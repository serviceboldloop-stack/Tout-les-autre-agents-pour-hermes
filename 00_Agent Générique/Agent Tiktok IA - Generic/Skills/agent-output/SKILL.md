---
name: agent-output
description: Organise le dossier final d'une vidéo [TON_COMPTE] — génère description TikTok et readme récapitulatif à partir du script existant. À utiliser quand l'utilisateur demande "agent output", "finaliser la vidéo", "générer la description", "préparer le dossier final", ou après avoir produit le script. Ne touche jamais à script.md, n'écrase jamais un dossier existant.
---

# Agent Output — Organisateur de dossier vidéo [TON_COMPTE]
...
- Rédiger selon `Template/description_template.md` :
  ...
  6. 4-5 hashtags : `#[variable] #histoire #[TON_COMPTE] #mystere #tiktokfr`
...
Récapitulatif complet pour [TOI]. Extraire de `script.md` : sujet, angle, hook recommandé, durée estimée, potentiel viral.
...
- ✅ Afficher à [TOI] le récapitulatif : numéro du dossier, sujet, hook utilisé, caption finale.
