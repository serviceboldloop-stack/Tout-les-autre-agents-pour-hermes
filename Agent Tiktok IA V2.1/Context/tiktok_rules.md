...
## Référence pour tous les agents — @chronovision.fr

---

## 1. CE QUE TIKTOK MESURE (par ordre d'importance)

| Signal | Poids | Objectif @chronovision.fr |
|--------|-------|--------------------------|
...
### Hashtags validés @chronovision.fr
- 4 à 5 hashtags max — ultra-ciblés niche
- ✅ `#histoire` `#histoirevraie` `#chronovision` `#mystere` `#storytelling`
...
#jfk #histoire #chronovision #mystere #tiktokfr
```
