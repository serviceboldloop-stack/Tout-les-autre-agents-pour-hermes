---
name: agent-prompts
description: Génère tous les prompts images (Freepik) et animations (Kling 2.5) scène par scène pour une vidéo @chronovision.fr à partir d'un script existant. À utiliser quand l'utilisateur demande "agent prompts", "générer les prompts", "prompts images", "prompts d'animation", ou après avoir produit un script. Produit outputs/video_N/prompts.md avec 17 à 26 scènes prêtes à copier-coller.
---

# Agent Prompts — Générateur de prompts visuels @chronovision.fr
